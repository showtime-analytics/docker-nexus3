...
A Dockerfile for Sonatype Nexus Repository Manager 3, based on AlpineLinux.
...
- [Sonatype official repository](https://github.com/sonatype/docker-nexus3) (documentation is based on it)
